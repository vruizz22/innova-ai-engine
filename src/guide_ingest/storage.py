...
class S3ObjectStore:
    ...
    def __init__(self, bucket: str | None = None) -> None:
        ...
        self._client = boto3.client("s3", region_name=settings.app_aws_region)  # type: ignore[misc]

    def get(self, key: str) -> bytes:
        resp = self._client.get_object(Bucket=self._bucket, Key=key)  # type: ignore[misc]
